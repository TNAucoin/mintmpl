...
/// </summary>
public sealed class ServiceClientTests : IDisposable
{
    ...
    {
        // Act
        Action act = () => new ServiceClient(null!);
    ...
    {
        // Act
        using var client = new ServiceClient(_configuration, _loggerMock.Object);
    ...
    {
        // Arrange
        var client = new ServiceClient(_configuration, _loggerMock.Object);
        client.Dispose();
