"""Configuration module for awesome_tool."""
...
@dataclass
class Config:
    """Configuration class for AwesomeService.

    This class holds all configuration options for the mypackage service.
    """

    # Database configuration
    database_name: str = "awesome_db"
    database_host: str = "localhost"
    database_port: int = 5432

    # Service configuration
    service_name: str = "awesome_tool"
    ...
    def from_env(cls) -> "Config":
        ...
        """
        return cls(
            database_name=os.getenv("DB_NAME", "awesome_db"),
            database_host=os.getenv("DB_HOST", "localhost"),
            database_port=int(os.getenv("DB_PORT", "5432")),
            service_name=os.getenv("SERVICE_NAME", "awesome_tool"),
